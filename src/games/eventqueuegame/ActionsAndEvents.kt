...
data class TransitStart(val transit: Transit) : Action {
    ...
    override fun visibleTo(player: Int, state: ActionAbstractGameState) = if (state is EventQueueGame) state.world.checkVisible(transit, numberToPlayerID(player)) else true
}
